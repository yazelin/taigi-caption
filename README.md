...
寫在前面：這個願望不是沒人做過，做的人都做了旁邊那件事。如果你只是想把台語轉成文字，下面兩個現成的可能就夠用，不必自己架一台機器。

| 現成方案 | 做什麼 | 落差 |
| --- | --- | --- |
| [雅婷逐字稿](https://studio.yating.tw/)（台灣人工智慧實驗室） | 免費，iOS 與 Android 與網頁都有，內建即時錄音與字幕模式，邊講邊出繁體中文字 | 語言選項是「國台語」混合而非純台語，官方 API 文件寫這顆模型「主要語言還是以國語為主」；輸出華語用字這點是從聯發科 benchmark 註腳推斷，未實機驗證；iOS 版 2024 年 3 月後未更新 |
| [教育部臺灣台語輸入法](https://apps.apple.com/tw/app/id6743423554)（[Android](https://play.google.com/store/apps/details?id=tw.moe.taiwanese.taigi)） | 免費官方，2026 年 1 月上架，有語音辨識 | 輸出的是台語漢字或臺羅，沒有華語模式；而且是輸入法鍵盤，不是字幕畫面 |

台語漢字與華語用字的差別，用同一句話最清楚。教育部那支會給你「伊講的話前後顛倒反，毋知影佗一句才是真的」，本專案給的是「他說的話前後相反，不知道哪一句才是真的」。對只懂華語的聽者，前者會卡在「毋知影」「佗一句」。這個願望要的是後者。

另外註記兩件事。聯發科的 Breeze AI LINE 官方帳號，官方文章寫可以對它講台語轉文字（用的就是本專案這顆 Breeze-ASR-26），但實測沒有回應，所以不列入可用選項。還有一件查下去才發現的事：**支援台語語音辨識的工具，目前全部出自台灣的單位**，也就是教育部、台灣人工智慧實驗室（雅婷）、聯發科這幾家；Apple、Google、微軟、OpenAI 沒有一家支援。具體到什麼程度：iOS 內建聽寫的語言清單裡有上海話，微軟 Azure 有山東話、四川話、吳語、粵語，就是沒有台語；Google 翻譯與 Android 即時轉錄同樣沒有。另外，連客家委員會都替客語做了[客語與華語的即時翻譯](https://speech.hakka.gov.tw/Translation/Online)，台語沒有對應的公部門服務。

所以本專案的價值不是「別人沒做」，而是另一種取捨：自架、開源、錄音不上傳到任何第三方、沒有時數限制、可以自己換模型調參數。想要方便就用上面兩個，想要自己掌握就用這個。
