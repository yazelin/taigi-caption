...
另外註記兩件事。聯發科的 Breeze AI LINE 官方帳號，官方文章寫可以對它講台語轉文字（用的就是本專案這顆 Breeze-ASR-26），但實測沒有回應，所以不列入可用選項。另外，Apple、Google、微軟、OpenAI 沒有一家支援台語。iOS 內建聽寫的語言清單裡有上海話，微軟 Azure 有山東話、四川話、吳語、粵語，就是沒有台語。連客家委員會都替客語做了[客語與華語的即時翻譯](https://speech.hakka.gov.tw/Translation/Online)，台語沒有對應的公部門服務。
